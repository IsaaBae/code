...
class GoPiGo3WithKeyboard(object):
    ...
    def __init__(self):
        ...
        "4" : ["Potna Dance", "dance_off"],
        "5" : ["Drive forward for 10 inches", "forward10in"],
        "6" : ["Drive forward for 360 degrees (aka 1 wheel rotation)", "forwardturn"],
        ...
        self.order_of_keys = ["w", "s", "a", "d", "<SPACE>", "4", "5", "6", "1", "2", "3", "8", "9", "0", "<INSERT>", "<ESC>"]
